...
<table id="dg" title='订单列表(此功能只能查询充值中订单，充值成功或充值失败订单请去"历史订单查询"功能中查询)' class="easyui-datagrid" 
        url="user/getOrderList.action" 
        fit="true"
        toolbar="#searchtool"
        pagination="true"
        striped="true"
    ...
    <thead>  
        <tr>  
            ...
            <th field="status" value="充值中" width="100">状态</th>   
        </tr>  
    </thead>  
</table>  
</div>
<div id="searchtool">  
      ...
      <a href="#" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="doClear()">清空</a>&nbsp;&nbsp;
